...
\begin{lstlisting}
cd ~/BIS_2013/Thu/RNA-seq/RNA-seq/
\end{lstlisting}
\end{steps}
...
\begin{warning}
  ...
  \textbf{\texttt{$\sim$/BIS\_2013/Thu/RNA-seq/RNA-seq/}} directory.
\end{warning}
...
alignment to speed up the alignment and keep its memory footprint small. Create
...
\begin{enumerate}
  ...
  \texttt{$\sim$/BIS\_2013/Thu/RNA-seq/RNA-seq/tophat/ZV9\_2cells} directory.
  ...
  stored in the \texttt{$\sim$/BIS\_2013/Thu/RNA-seq/RNA-seq/annotation} directory.
...
\begin{warning}
Note that the coverage on the Ensembl browser is based on raw reads and thus do
not represent normalised values such as FPKMs.
\end{warning}
...
\subsection{Functional Annotation of Differentially Expressed Genes}
\begin{bonus}
