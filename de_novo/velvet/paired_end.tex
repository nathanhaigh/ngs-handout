...
paired-end constraint violation (expected disatnce and orientation of paired
...
\begin{answer}
There is quite a high proportion of compressed mates and very few stretched
mates.
\end{answer}
...
or incorrectly orientated mates? What might this situation indicate?
\begin{answer}
This would indicate a possible missassembly and worthy of further
investiogation.
\end{answer}
\end{questions}
...
avoid uneccassary disk read/write.
...
\begin{answer}
K-mer has to be lower than the read length and the Kmer coverage should be
