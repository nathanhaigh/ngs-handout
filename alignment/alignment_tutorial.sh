...
cd ~/ChIP-seq
bowtie --help
time bowtie-build bowtie_index/mm10.fa bowtie_index/mm10               # 8m20s
ls -l bowtie_index
time bowtie bowtie_index/mm10 -S Oct4.fastq > Oct4.sam                # 30s
head -n 10 Oct4.sam
...
time bowtie bowtie_index/mm10 -S gfp.fastq > gfp.sam                  # 30s
head -n 10 gfp.sam
...
genomeCoverageBed -bg -ibam gfp.sorted.bam \
  -g bowtie_index/mouse.mm10.genome > gfp.bedgraph
bedGraphToBigWig gfp.bedgraph \
  bowtie_index/mouse.mm10.genome gfp.bw
